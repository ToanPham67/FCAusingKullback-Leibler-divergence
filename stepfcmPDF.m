function [U_new, center, obj_fcn, dist] = stepfcmPDF(data, U, cluster_n, expo)
...
%dist = kl_divergenceAB(center, data);       % fill the distance matrix
for i = 1: size(data,1)
for j = 1: size(center,1)
    dist(j,i) = kl_divergenceAB(center(j,:), data(i,:));
end
end
